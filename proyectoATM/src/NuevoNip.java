...
import ATM.banco.*;
import ATM.*;
public class NuevoNip extends JFrame{  //JFrame que pide contraseña
	...
	public NuevoNip()
	{
		...
		titulo.setText("DIGITE SU NUEVO NIP");
		titulo.setBounds(280, 100, 270, 30);
		...
		continuar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				ConfirmarNuevoNip nueva_ventana = new ConfirmarNuevoNip(textPass);
				setVisible(false);
			}
		});
