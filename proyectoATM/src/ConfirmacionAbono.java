...
public class ConfirmacionAbono extends JFrame{//Preguntar si quieren retirar la cantidad elegida
	...
	public ConfirmacionAbono(String numero, String numeroCuenta) 
	{	
		super("ATM");
		...
		titulo.setText("ESTA SEGURO QUE QUIERE ABONAR:");
		...
		aceptar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
					String outputStr = "SU DINERO FUE ABONADO CORRECTAMENTE";
